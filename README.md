...
Urgencias:  
El cliente puede visualizar en tiempo real a los profesionales disponibles y cercanos mediante geolocalización, obteniendo una respuesta rápida y un presupuesto inmediato.
Trabajos programados:  
El cliente puede solicitar un presupuesto, comparar precios entre distintos profesionales, revisar calificaciones y coordinar una fecha para la realización del servicio.
Cada profesional define su propio precio para cada servicio que ofrece, permitiendo al cliente comparar opciones y elegir la más conveniente. Además, los clientes pueden dejar reseñas y calificaciones luego de cada trabajo, lo que contribuye a la reputación del profesional dentro de la plataforma.
La aplicación también incorpora un sistema de métodos de pago, permitiendo que los clientes abonen los servicios mediante tarjetas de crédito, débito, billeteras virtuales o efectivo. Asimismo, podrán aplicarse promociones o descuentos asociados a determinados medios de pago, brindando mayor flexibilidad y beneficios al momento de contratar un servicio
La aplicación contempla tres tipos de usuarios:
Administrador: gestiona servicios, especialidades, usuarios, zonas y localidades.
Cliente: solicita servicios, compara profesionales y califica trabajos.
